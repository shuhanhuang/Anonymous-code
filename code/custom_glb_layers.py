...
from custom_gate import HyperRouterGate
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def __init__(
        ...
        **kwargs
        ...
        if hyper_size is not None and gate_name == "HyperRouterGate":
            self.gate = gate(d_model, num_expert, world_size, top_k, hyper_size)
        elif gate_name == "GlobalRouterGate":
            self.gate = gate(d_model, num_expert, world_size, top_k)
        elif gate_name == "EnhancedGlobalRouterGate":

        
            args = kwargs.get('args', None)
            self.gate = gate(d_model, num_expert, world_size, top_k, args=args)
        else:
