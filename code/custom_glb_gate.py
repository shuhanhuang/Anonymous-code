...
from global_router_gate import GlobalRouterGate
from local_neighborhood_router_gate import LocalNeighborhoodRouterGate
from ablation_global_router_gate import EnhancedGlobalRouterGate
...
__all__ = ['HyperRouterGate','CustomNaiveGate', 'CustomDropGate', 'CustomRandomGate', 'CustomRandomGate_Dense',
            ...
            'GlobalRouterGate', 'LocalNeighborhoodRouterGate', 'EnhancedGlobalRouterGate']
...
class CustomNaiveGate(BaseGate):
    ...
    def forward(self, inp, return_all_scores=False):
        ...
        # 保存routing信息用于layer statistics收集
        self.last_routing_indices = gate_top_k_idx
        self.last_routing_weights = gate_score
